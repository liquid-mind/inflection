...
public class TypeImportTest extends AbstractInflectionTest
{
	...
	public void testTypeImport_SingleTypeLegalImport_SuccessfulCompilation() throws Exception
	{
		...
		} , createInflectionFileMock( "a", "package a; taxonomy A {}" ), createInflectionFileMock( "b", "package b; import a.A;" ) );
	}
	...
	public void testTypeImport_SingleTypeIllegalImport_CompilationFailure() throws Exception
	{
		...
		} , createInflectionFileMock( "a", "package a; taxonomy A {}" ), createInflectionFileMock( "b", "package b; import a.B;" ) );
	}
	...
	public void testTypeImport_SingleTypeMultipleImports_SuccessfulCompilation() throws Exception
	{
		doTest( job -> {
			InflectionCompilerTestUtility.assertSuccessfulCompilation( job );
		} , createInflectionFileMock( "a", "package a; taxonomy A {}" ), createInflectionFileMock( "b", "package b; taxonomy B {}" ), createInflectionFileMock( "c", "package c; import a.A; import b.B;" ) );
	}
	...
	public void testTypeImport_SingleTypeDuplicateImport_CompilationFailure() throws Exception
	{
		...
		} , createInflectionFileMock( "a", "package a; taxonomy A {}" ), createInflectionFileMock( "b", "package b; taxonomy A {}" ), createInflectionFileMock( "c", "package c; import a.A; import b.A;" ) );
	}
