...
public class Demo
{
	...
	private static void demo14()
	{
		...
		List< ValidationError > errors = ExtendedOperations.validate( customer, "ch.zhaw.inflection.demo.FullGroup", "ch.zhaw.inflection.demo.FullGroupValidation" );
	...
	private static void demo13()
	{
		compile();
		Customer customer = createCustomer();
		ExtendedOperations.toJson( customer, "ch.zhaw.inflection.demo.FullGroup", null );
	}
...
//		a2.b13 = null;
		...
		boolean isEqual = BasicOperations.equals( a1, a2, "ch.zhaw.inflection.demo.ABGroup", null );
	...
	private static void demo11()
	{
		...
		boolean isEqual = BasicOperations.equals( customer1, customer2, "ch.zhaw.inflection.demo.FullGroup", null );
	...
	private static void demo10()
	{
		compile();
		Customer customer = createCustomer();
		int hashcode = BasicOperations.hashcode( customer, "ch.zhaw.inflection.demo.FullGroup", null );
	...
	private static void demo9()
	{
		compile();
		Customer customer = createCustomer();
		BasicOperations.toText( customer, "ch.zhaw.inflection.demo.FullGroup", null );
	}
	...
	private static void demo8()
	{
		compile();
		Customer customer = createCustomer();
		BasicOperations.metaModelToText( customer, "ch.zhaw.inflection.demo.FullGroup", null );
	}
	...
	private static void compile()
	{
		...
		InflectionCompilerBootstrap.compile(
			new File[] {
				...
				new File( "./src/main/resources/ch/zhaw/inflection/demo/Demo.inflect" ) },
